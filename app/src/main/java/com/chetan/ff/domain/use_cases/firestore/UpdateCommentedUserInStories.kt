...
class UpdateCommentedUserInStories @Inject constructor(
    private val frepository: FirestoreRepository
) {
    suspend operator fun invoke(data: StoriesDetailRequestResponse) = frepository.updateCommentedUserInStories(data)
}